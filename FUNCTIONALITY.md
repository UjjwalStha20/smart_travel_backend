...
data/              # seed CSVs (destinations, routes, prices, ...)
scripts/           # seed.py, import_csv.py
...
- **Seed data**: imports 19 destinations, trek routes (ABC, Poon Hill, EBC, Langtang),
  route points with real coordinates/altitudes, permit & entry-fee prices,
  accommodation/food cost tiers, itineraries, blogs.
- **Tests**: 78 passing (auth, CRUD, recommendations, optimizers, travel info,
  chat tools, weather-in-recommender).
